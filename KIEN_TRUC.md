...
| `V6_DONG_GOI/` | 22 | 1 | He V6 dong goi CHAY THAT moi sang — tu chua (`%~dp0`), khong phu thuoc goc. Dung dong. |
...
- **`duong_dan`** (160 dong, 7 noi goi) — MOT CHO duy nhat giai cac duong dan phu thuoc MAY.
...
- **`tai_tro`** (144 dong, 2 noi goi) — CARRY cua mot vi the chi so giu qua dem.
...
- `mo_phong_v2.py` ⚠MO COI — Bo mo phong luoi DCA v2, gom co che tu CAC HE THONG NGOAI
