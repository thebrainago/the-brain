...
| `quantlab.ho_so_song` | 42.1 | TOT | HO_SO_SONG.json ghi lan cuoi cach day 42 gio |
| `quantlab.ho_so_mua_vu` | 42.1 | TOT | HO_SO_MUA_VU.json ghi lan cuoi cach day 42 gio |
| `quantlab.ho_so_tuong_quan` | 42.1 | TOT | HO_SO_TUONG_QUAN_D1.json ghi lan cuoi cach day 42 gio |
| `quantlab.ho_so_suy_nguoc` | 42.1 | TOT | SUY_NGUOC.json ghi lan cuoi cach day 42 gio |
| `quantlab.ho_so_to_hop` | 42.1 | TOT | TO_HOP.json ghi lan cuoi cach day 42 gio |
| `quantlab.ket_qua` | 0 | XAU | 0 dong trong ket_qua |
| `evo.van_de_mo` | 1 | TOT | 1 MO / 16 da sua |
| `evo.bai_hoc` | 3 | XAU | 3 the bai hoc |
| `evo.finder` | 42.1 | TOT | san_cong_cu = Finder cua so do |
