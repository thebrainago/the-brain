...
| `thong_luong.nut_that` | ban doc -> thanh phan 4.1% | TOT | 6933 vao -> 285 ra. Day la cho dang gioi han san luong ca he - noi rong cho khac khong lam |
| `dia.con_trong` | 8.7 | TOT | 8.7 GB trong / 119 GB tong (93% da dung) |
| `dia.nao_db` | 1383 | TOT | bang `noi_dung` (toan van tai lieu) chiem phan lon - do la du lieu THAT, khong phai rac; m |
