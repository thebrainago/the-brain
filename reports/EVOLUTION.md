...
|---|---|---|---|
| SEEKER | 2026-09-13 10:43:16 | 15 phut | nghi |
| QUANTLAB | 2026-09-13 10:39:27 | 18 phut | chay |
| NGHI | 2026-09-13 10:02:50 | 55 phut | nghi |
| BANKER | 2026-09-13 10:57:43 | 0 phut | nghi |
| EVO | 2026-09-13 10:58:18 | 0 phut | chay |

## 2. San luong
- Tai lieu da thu: **11771**
...
- Viec: cho 12 / treo 0 / loi 0
- Ty le vong lap rong cua SEEKER: **86%**
- Nang suat doc cua SEEKER: **0.17 gia thuyet/100 bai** (4 gia thuyet truy nguyen ve URL tai lieu, tren 2341 bai da boc; 616 ung vien tu 6849 artifact tai lieu). Noi sinh khong tinh vao day: 383 gia thuyet.
...
- Do sau quet (con tro bien gioi): etoro 0 trang/vong 0, mql5_code 3 trang/vong 0, tradingview_scripts 0 trang/vong 0

## 3. Hieu chuan (thu quan trong hon so PASS)
- **Null factory: 50% ca KHONG CO EDGE lot qua cong** (do luc 2026-09-13 09:34:32, muc tieu <= 10%)
  Day la phep do hieu chuan DUY NHAT dang tin: cho thu khong co edge di qua ca day chuyen roi dem xem bao nhieu lot.
- **Bai kiem LUC: cong PHAN BIET DUOC co edge voi khong co edge** (do luc 2026-09-13 09:34:34)
...
- **Thoi gian song 7 ngay: 100.0%** (mat 166.6 gio qua 1 lan gian doan - may ngu hoac tat, khong phai tru chet)
- **Supervisor restart 24h: 1 lan** (0.04 lan/gio, tran 3) - ma thoat {"15": 1}, lan cuoi 2026-09-13 09:57:25
- Dia trong: **7.6 GB** - MT5 tick-test: **KHOA (dia < 15GB)**
- So cai: LANH (17677 dong lien mach)
...
| rss_betterbuyandhold | 5 | 0 | 3 | BAT |
| rss_beyondpassive | 5 | 0 | 13 | BAT |
| rss_buildalpha | 6 | 0 | 5 | BAT |
| rss_capitalspectator | 5 | 0 | 13 | BAT |
| rss_concretumgroup | 5 | 0 | 12 | BAT |
| rss_crackingmarkets | 5 | 0 | 12 | BAT |
| rss_factorinvestor | 1 | 0 | 12 | BAT |
| rss_fh_financial_hacker | 6 | 0 | 10 | BAT |
| rss_followingthetrend | 6 | 0 | 4 | BAT |
...
| rss_mql5_articles | 6 | 0 | 12 | BAT |
| rss_mrzepczynski | 6 | 0 | 26 | BAT |
...
| rss_priceactionlab | 6 | 0 | 19 | BAT |
| rss_qoppac | 6 | 0 | 15 | BAT |
...
| stackexchange | 34 | 0 | 161 | BAT |
| telegram | 9 | 0 | 42 | BAT |
| tiktok | 5 | 0 | 101 | BAT |
| tradingview_ideas | 2 | 0 | 3 | BAT |
| tradingview_pine | 35 | 0 | 24 | BAT |
...
- **[NANG]** `dia_thap` - Dia con 7.6 GB (< 15) -> MT5 tick-test bi KHOA, tuc dang tu cam minh lam buoc quyet dinh cua chinh du an
...
- **[NANG]** `llm_874a010e43` - [LLM chan doan] Tru NGHI và BANKER dừng hoạt động quá hạn
...
- **[VUA]** `tru_loi_QUANTLAB` - Tru QUANTLAB khong lanh manh (lan 1 lien tiep)
- **[VUA]** `llm_5cf5cc4505` - [LLM chan doan] Lỗi xử lý LLM/EVO tích lũy làm nghẽn pipeline
...
- **[VUA]** `llm_e92fd83040` **x8 lan** (gan nhat 2026-09-12 21:58:47) - EVO/xay.viec_hong: viec loi / qua han
- **[VUA]** `llm_e502b66769` **x8 lan** (gan nhat 2026-09-12 21:58:47) - EVO/evo.van_de_mo: van de con mo
